...
A = MyNorm_test(I_x_te{1, idx1}, I_x_tr{1,idx1});
B = MyNorm_test(I_x_te{1,idx2},I_x_tr{1,idx2});
...
A = MyNorm_test(M_x_te{1, idx1}, M_x_tr{1,idx1});
B = MyNorm_test(M_x_te{1,idx2}, M_x_tr{1,idx2});
...
A = MyNorm_test(C_x_te{1, idx1}, C_x_tr{1,idx1});
B = MyNorm_test(C_x_te{1,idx2}, C_x_tr{1,idx2});
